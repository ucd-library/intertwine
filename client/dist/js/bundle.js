...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const n={},o=/-[a-z]/g,r=/([A-Z])/g;function s(t){return n[t]||(n[t]=t.indexOf("-")<0?t:t.replace(o,t=>t[1].toUpperCase()))}function a(t){return n[t]||(n[t]=t.replace(r,"-$1").toLowerCase())}},function(t,e,i){t.exports={BaseModel:i(45),BaseStore:i(47),BaseService:i(49),BaseMixin:i(51),Mixin:i(52),EventBus:i(22),EventInterface:i(53),LitCorkUtils:i(54),fetch:i(36),LightDom:i(55)}},function(t,e,i){"use strict";i.d(e,"b",(function(){return o}));i(3);var n=i(12);i.d(e,"a",(function(){return n.b}));
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const I=new class{handleAttributeExpressions(t,e,i,n){const o=e[0];if("."===o){return new T(t,e.slice(1),i).parts}return"@"===o?[new A(t,e.slice(1),n.eventContext)]:"?"===o?[new k(t,e.slice(1),i)]:new S(t,e,i).parts}handleTextExpression(t){return new P(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */document.head.appendChild(Pt.content);const Tt=new WeakMap,Et=o(t=>e=>{if(!(e instanceof P))throw new Error("unsafeHTML can only be used in text bindings");const i=Tt.get(e);if(void 0!==i&&z(t)&&t===i.value&&e.value===i.fragment)return;const n=document.createElement("template");n.innerHTML=t;const o=document.importNode(n.content,!0);e.setValue(o),Tt.set(e,{value:t,fragment:o})});function Ot(){return V`
  ${ct}
  <style>
    :host {
      display: block;
              ...
              ${this.connections.map(t=>V`
                <div class="dot-list">
                  ...
                  <div>
                    ...
                    ${t.link.formattedConnection?V`${Et(t.link.formattedConnection)}`:V`<strong><em>${t.link.name}</em></strong>&nbsp;${t.node.name}`}
                    </a>
                  </div>
                </div>
              `)}
...
`}customElements.define("app-header",te);var ie=i(41),ne=i.n(ie),oe=i(42),re=i.n(oe),se=i(43),ae=i.n(se);function le(){return V`
  <style>
    ${ne.a}
    ${re.a}
    ${ae.a}
