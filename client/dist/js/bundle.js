    ...
    <main>
      ${this.moments.map(t=>j`
        <div id="${t.entryPoint.shortName}" class="${t.entryPoint.shortName}">
          <div class="card">
            <div class="feature-img ${t.entryPoint.shortName}"></div>
            <div class="content">
