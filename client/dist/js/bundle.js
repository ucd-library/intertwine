...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const P=Object(C.a)(l(Object(o.a)(HTMLElement)));customElements.define("dom-bind",class extends P{static get observedAttributes(){return["mutable-data"]}constructor(){if(super(),h.g)throw new Error("strictTemplatePolicy: dom-bind not allowed");this.root=null,this.$=null,this.__children=null}attributeChangedCallback(t,e,i,n){this.mutableData=!0}connectedCallback(){M()||(this.style.display="none"),this.render()}disconnectedCallback(){this.__removeChildren()}__insertChildren(){Object(c.a)(Object(c.a)(this).parentNode).insertBefore(this.root,this)}__removeChildren(){if(this.__children)for(let t=0;t<this.__children.length;t++)this.root.appendChild(this.__children[t])}render(){let t;if(!this.__children){if(t=t||this.querySelector("template"),!t){let e=new MutationObserver(()=>{if(t=this.querySelector("template"),!t)throw new Error("dom-bind requires a <template> child");e.disconnect(),this.render()});return void e.observe(this,{childList:!0})}this.root=this._stampTemplate(t),this.$=this.root.$,this.__children=[];for(let t=this.root.firstChild;t;t=t.nextSibling)this.__children[this.__children.length]=t;this._enableProperties()}this.__insertChildren(),this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}});var k=i(17),O=i(12),E=i(16),T=i(1),A=i(6);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
let Y;window.customElements.define("custom-style",W),Y=a._mutablePropertyChange;Boolean;i(8);i.d(e,"a",(function(){return J}));
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const J=Object(n.a)(HTMLElement).prototype},function(t,e,i){"use strict";i.d(e,"a",(function(){return n})),i.d(e,"b",(function(){return r})),i.d(e,"c",(function(){return s}));i(3),i(4),i(6);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const n={},o=/-[a-z]/g,r=/([A-Z])/g;function s(t){return n[t]||(n[t]=t.indexOf("-")<0?t:t.replace(o,t=>t[1].toUpperCase()))}function a(t){return n[t]||(n[t]=t.replace(r,"-$1").toLowerCase())}},function(t,e,i){t.exports={BaseModel:i(45),BaseStore:i(47),BaseService:i(49),BaseMixin:i(51),Mixin:i(52),EventBus:i(22),EventInterface:i(53),LitCorkUtils:i(54),fetch:i(35),LightDom:i(55)}},function(t,e,i){"use strict";i.d(e,"b",(function(){return o}));i(3);var n=i(12);i.d(e,"a",(function(){return n.b}));
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * rights grant found at http://polymer.github.io/PATENTS.txt
 */
const J=/:host\(:dir\((ltr|rtl)\)\)/g,K=':host([dir="$1"])',X=/([\s\w-#\.\[\]\*]*):dir\((ltr|rtl)\)/g,Q=':host([dir="$2"]) $1',tt=/:dir\((?:ltr|rtl)\)/,et=Boolean(window.ShadyDOM&&window.ShadyDOM.inUse),it=[];let nt=null,ot="";function rt(){ot=document.documentElement.getAttribute("dir")}function st(t){if(!t.__autoDirOptOut){t.setAttribute("dir",ot)}}function at(){rt(),ot=document.documentElement.getAttribute("dir");for(let t=0;t<it.length;t++)st(it[t])}const lt=Object(Y.a)(t=>{et||nt||(rt(),nt=new MutationObserver(at),nt.observe(document.documentElement,{attributes:!0,attributeFilter:["dir"]}));const e=Object(W.a)(t);class i extends e{static _processStyleText(t,i){return t=e._processStyleText.call(this,t,i),!et&&tt.test(t)&&(t=this._replaceDirInCssText(t),this.__activateDir=!0),t}static _replaceDirInCssText(t){let e=t;return e=e.replace(J,K),e=e.replace(X,Q),e}constructor(){super(),this.__autoDirOptOut=!1}ready(){super.ready(),this.__autoDirOptOut=this.hasAttribute("dir")}connectedCallback(){e.prototype.connectedCallback&&super.connectedCallback(),this.constructor.__activateDir&&(nt&&nt.takeRecords().length&&at(),it.push(this),st(this))}disconnectedCallback(){if(e.prototype.disconnectedCallback&&super.disconnectedCallback(),this.constructor.__activateDir){const t=it.indexOf(this);t>-1&&it.splice(t,1)}}}return i.__activateDir=!1,i});i(3);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
`}customElements.define("app-map-info-panel",Ht);function Nt(){return V`
    <style>
      :host {
        display: block;
        height: 100%;
          ...
          <div>
            <div class="card">
              <div class="feature-img" 
                @click="${e=>this._onReadStoryClick(t.entrypoint.story)}" 
                style="cursor: pointer; background-image: url('${t.entrypoint.thumbnail}');"></div>
              <div class="content">
...
`}customElements.define("app-about",class extends ht{static get properties(){return{}}constructor(){super(),this.render=It.bind(this)}});class jt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{moments:{type:Array},moment:{type:String}}}constructor(){super(),this.render=Nt.bind(this),this.moments=[],this.moment="",this.loadMoments(),this._injectModel("AppStateModel","MomentModel")}loadMoments(t){t?(this.moments.push(t),this.requestUpdate()):this.moment=APP_CONFIG.moments[0]}async firstUpdated(t){let e,i;for(let t=0;t<APP_CONFIG.moments.length;t++)e=await this.MomentModel.get(APP_CONFIG.moments[t]),e.error||(i=e.payload.graph.story,i.entrypoint.thumbnail?i.entrypoint.thumbnail=APP_CONFIG.endpoint+"/"+APP_CONFIG.moments[t]+"/"+i.entrypoint.thumbnail:i.entrypoint.thumbnail=APP_CONFIG.endpoint+"/"+APP_CONFIG.moments[t]+"/thumbnail.jpg",this.loadMoments(e.payload.graph.story))}_onReadStoryClick(t){this.AppStateModel.setLocation("/story/"+t)}_onExploreMapClick(t){this.AppStateModel.setLocation("/map/"+t)}}customElements.define("app-home",jt);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Rt=(t,e)=>{const i=t.startNode.parentNode,n=void 0===e?t.endNode:e.startNode,o=i.insertBefore(v(),n);i.insertBefore(v(),n);const r=new P(t.options);return r.insertAfterNode(o),r},Vt=(t,e)=>(t.setValue(e),t.commit(),t),Bt=(t,e,i)=>{const n=t.startNode.parentNode,o=i?i.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&a(n,e.startNode,r,o)},Dt=t=>{l(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},Zt=(t,e,i)=>{const n=new Map;for(let o=e;o<=i;o++)n.set(t[o],o);return n},Ft=new WeakMap,Ut=new WeakMap,qt=o((t,e,i)=>{let n;return void 0===i?i=e:void 0!==e&&(n=e),e=>{if(!(e instanceof P))throw new Error("repeat can only be used in text bindings");const o=Ft.get(e)||[],r=Ut.get(e)||[],s=[],a=[],l=[];let h,c,d=0;for(const e of t)l[d]=n?n(e,d):d,a[d]=i(e,d),d++;let p=0,u=o.length-1,f=0,m=a.length-1;for(;p<=u&&f<=m;)if(null===o[p])p++;else if(null===o[u])u--;else if(r[p]===l[f])s[f]=Vt(o[p],a[f]),p++,f++;else if(r[u]===l[m])s[m]=Vt(o[u],a[m]),u--,m--;else if(r[p]===l[m])s[m]=Vt(o[p],a[m]),Bt(e,o[p],s[m+1]),p++,m--;else if(r[u]===l[f])s[f]=Vt(o[u],a[f]),Bt(e,o[u],o[p]),u--,f++;else if(void 0===h&&(h=Zt(l,f,m),c=Zt(r,p,u)),h.has(r[p]))if(h.has(r[u])){const t=c.get(l[f]),i=void 0!==t?o[t]:null;if(null===i){const t=Rt(e,o[p]);Vt(t,a[f]),s[f]=t}else s[f]=Vt(i,a[f]),Bt(e,i,o[p]),o[t]=null;f++}else Dt(o[u]),u--;else Dt(o[p]),p++;for(;f<=m;){const t=Rt(e,s[m+1]);Vt(t,a[f]),s[f++]=t}for(;p<=u;){const t=o[p++];null!==t&&Dt(t)}Ft.set(e,s),Ut.set(e,l)}});function $t(){return V`
  ${ct}
  <style>
    .floating-btn {
      position: absolute;
  ...
  `}function Gt(){return V`
    ...
    <div id="container" class="container" role="main">
      ...
      ${this.story.triptych&&this.story.triptych["@id"]?V`
          <div class="triptych">
          ${qt(this.story.triptych&&this.story.triptych.image,t=>V`
...
`}customElements.define("app-story-float-btn",class extends ht{static get properties(){return{}}constructor(){super(),this.render=$t.bind(this)}});class Wt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{endpoint:{type:String},headerImgUrl:{type:String},moment:{type:String},paragraphs:{type:Array},story:{type:Object},sources:{type:Array},title:{type:String}}}constructor(){super(),this.render=Gt.bind(this),this.endpoint=APP_CONFIG.endpoint,this.moment="",this.headerImgUrl="",this.paragraphs=[],this.story={},this.sources=[],this.paragraphs=[],this.title="",this._injectModel("AppStateModel","MomentModel")}async firstUpdated(){this.container=this.shadowRoot.querySelector("#container"),window.IntersectionObserver||(console.log("Injecting IntersectionObserver polyfill"),await i.e(0).then(i.t.bind(null,81,7))),this._initIntersectionObserver()}async _onAppStateUpdate(t){this.container.scrollTo(0,0),this.moment=t.moment;let e=await this.MomentModel.get(this.moment);this.renderStory(e.payload)}renderStory(t){if(t){if(0!==Object.keys(t.graph.story).length&&(this.story=t.graph.story,this.title=t.graph.story.entrypoint.name,t.graph.story.entrypoint.thumbnail?null===t.graph.story.entrypoint.thumbnail.match(/^https?:\/\//g)?this.headerImgUrl=this.endpoint+"/"+this.moment+"/"+t.graph.story.entrypoint.thumbnail:this.headerImgUrl=t.graph.story.entrypoint.thumbnail:this.headerImgUrl=this.endpoint+"/"+this.moment+"/thumbnail.jpg",this.story.sources)){this.sources=[];for(let t in this.story.sources.publication){let e=this.story.sources.publication[t].split(/\[|\]/),i={text:e[0],link:e[1],href:e[2]?e[2].replace(/\(|\)/,""):""};this.sources.push(i)}}this.paragraphs=[];for(let t in this.story)t.includes("paragraph")&&!t.includes("1")&&this.paragraphs.push(this.story[t])}}_initIntersectionObserver(){this.floatBtn=this.shadowRoot.getElementById("floatBtn"),this.footer=this.shadowRoot.querySelector("footer");new window.IntersectionObserver(t=>{t[0].isIntersecting?this.floatBtn.classList.add("hidden"):this.floatBtn.classList.remove("hidden")}).observe(this.footer)}_launchMap(){this.AppStateModel.setLocation("/map/"+this.moment)}}customElements.define("app-story",Wt);class Yt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{baseUrl:{type:String},subtitle:{type:String},moments:{type:Array}}}constructor(){super(),this.baseUrl=window.location.protocol+"//"+window.location.host,this.subtitle="",this.moments=[],this.render=kt.bind(this),this._injectModel("AppStateModel","MomentModel")}async _onAppStateUpdate(t){if("home"===t.page||"about"===t.page)this.subtitle="California's Modern Wine Network";else{this.moment=t.moment;let e=await this.MomentModel.get(this.moment);this._setSubtitle(e.payload)}}_setSubtitle(t){0!==Object.keys(t.graph.story).length&&(this.subtitle=t.graph.story.entrypoint.name)}_onAboutClick(){this.AppStateModel.setLocation("/about/")}}function Jt(){return V`
  <style>
    :host {
      display: block;
      position: absolute;
...
`}customElements.define("app-header",Yt);var Kt=i(41),Xt=i.n(Kt),Qt=i(42),te=i.n(Qt),ee=i(43),ie=i.n(ee);function ne(){return V`
  <style>
    ${Xt.a}
    ${te.a}
    ${ie.a}
