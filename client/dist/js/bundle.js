    ...
    <div class="content-padding">
      <iron-pages selected="${this.view}" attr-for-selected="id">
        ...
        <div id="item">
          ...
          ${this.imageCreditLink["@id"]?V`<div class="imageCredit">
...
`}customElements.define("app-about",class extends ht{static get properties(){return{}}constructor(){super(),this.render=It.bind(this)}});class jt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{moments:{type:Array},moment:{type:String}}}constructor(){super(),this.render=Nt.bind(this),this.moments=[],this.moment="",this.loadMoments(),this._injectModel("AppStateModel","MomentModel")}loadMoments(t){t?(this.moments.push(t),this.requestUpdate()):this.moment=APP_CONFIG.moments[0]}async firstUpdated(t){let e,i;this.container=this.shadowRoot.querySelector("section");for(let t=0;t<APP_CONFIG.moments.length;t++)e=await this.MomentModel.get(APP_CONFIG.moments[t]),e.error||(i=e.payload.graph.story,i.entrypoint.thumbnail?i.entrypoint.thumbnail=APP_CONFIG.endpoint+"/"+APP_CONFIG.moments[t]+"/"+i.entrypoint.thumbnail:i.entrypoint.thumbnail=APP_CONFIG.endpoint+"/"+APP_CONFIG.moments[t]+"/thumbnail.jpg",this.loadMoments(e.payload.graph.story))}_onAppStateUpdate(t){this.container.scrollTo(0,0)}_onReadStoryClick(t){this.AppStateModel.setLocation("/story/"+t)}_onExploreMapClick(t){this.AppStateModel.setLocation("/map/"+t)}}customElements.define("app-home",jt);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
      ...
      ${this.orderedStory.map(t=>V`
        <section class="${t.label}">
          ...
          ${"triptych"===t.label?V`
            <div class="triptych">
              ${qt(t.image,t=>V`
                <div style="background-image: url('${this.endpoint}/${this.moment}/${t.contentUrl}');">
                  <span>${t.caption}</span>
                </div>`)}
            </div>`:V``}
        </section>
