...
`}customElements.define("app-map-info-panel",At);function It(){return j`
    <style>
      :host {
        display: block;
        height: 100%;
...
`}customElements.define("app-about",class extends at{static get properties(){return{active:{type:Boolean}}}constructor(){super(),this.render=Ht.bind(this),this.active=!0}});let Nt=i(32);class jt extends(Mixin(at).with(LitCorkUtils)){static get properties(){return{active:{type:Boolean},moments:{type:Array}}}constructor(){super(),this.render=It.bind(this),this.active=!0,this.moments=[],this.loadMoments(),this._injectModel("AppStateModel","MomentModel")}loadMoments(){for(let t in Nt.moments)this.moments.push(Nt.moments[t])}_onReadStoryClick(t){this.AppStateModel.setLocation("/story/"+t)}_onExploreMapClick(t){this.AppStateModel.setLocation("/map/"+t)}}function Rt(){return j`
  ${lt}
  <style>
    .floating-btn {
      position: absolute;
  ...
  `}customElements.define("app-home",jt);function Vt(){return j`
    ${lt}
    <style>
      :host {
        display: block;
...
`}customElements.define("app-story-float-btn",class extends at{static get properties(){return{active:{type:Boolean}}}constructor(){super(),this.render=Rt.bind(this),this.active=!0}});let Bt=i(32);class Dt extends(Mixin(at).with(LitCorkUtils)){static get properties(){return{active:{type:Boolean},selectedMoment:{type:String},story:{type:Object}}}constructor(){super(),this.render=Vt.bind(this),this.active=!0,this._injectModel("AppStateModel")}_onAppStateUpdate(t){this.selectedMomentName=t.moment,this.story=Bt.moments[this.selectedMomentName]}async firstUpdated(){window.IntersectionObserver||(console.log("Injecting IntersectionObserver polyfill"),await i.e(0).then(i.t.bind(null,81,7))),this._initIntersectionObserver()}_initIntersectionObserver(){this.floatBtn=this.shadowRoot.getElementById("floatBtn"),this.footer=this.shadowRoot.querySelector("footer");new window.IntersectionObserver(t=>{t[0].isIntersecting?(this.floatBtn.style.visibility="hidden",this.floatBtn.style.opacity=0,this.floatBtn.style.transition="visibility 0s .5s, opacity .5s ease"):(this.floatBtn.style.visibility="visible",this.floatBtn.style.opacity=1)}).observe(this.footer)}_launchMap(){this.AppStateModel.setLocation("/map/"+this.selectedMomentName)}}customElements.define("app-story",Dt);let Zt=i(32);class Ft extends(Mixin(at).with(LitCorkUtils)){static get properties(){return{baseUrl:{type:String},subtitle:{type:String}}}constructor(){super(),this.baseUrl=window.location.protocol+"//"+window.location.host,this.subtitle="",this.render=Mt.bind(this),this._injectModel("AppStateModel")}_onAppStateUpdate(t){if("home"===t.page)this.subtitle="California's Modern Wine Network";else for(let e in Zt.moments)t.moment===e&&(this.subtitle=Zt.moments[e].title)}_onAboutClick(){this.AppStateModel.setLocation("/about/")}}function Ut(){return j`
  <style>
    :host {
      display: block;
      position: absolute;
...
`}customElements.define("app-header",Ft);var qt=i(41),$t=i.n(qt),Gt=i(42),Wt=i.n(Gt),Jt=i(43),Yt=i.n(Jt);function Kt(){return j`
  <style>
    ${$t.a}
    ${Wt.a}
    ${Yt.a}
