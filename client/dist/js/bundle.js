    ...
    <div id="container" class="container" role="main">      
      ...
      ${this.story.text1?V`
        <section class="text-blocks bg-white">
          ...
          ${this.story.text1.paragraphs.map(t=>V`<p>${t}</p>`)}
        </section>`:V``}     
      ...
      ${this.story.text2?V`
        <section class="text-image-pairing bg-tan">
          ...
          <div class="text-blocks">
            ...
            ${this.story.text2.paragraphs.map(t=>V`<p>${t}</p>`)}
          </div>
        </section>`:V``}
      ...
      ${this.story.text3?V`
        <section class="text-blocks bg-white">
          ...
          ${this.story.text3.paragraphs.map(t=>V`<p>${t}</p>`)}
        </section>`:V``}    

      ${this.story.text4?V`
        <section class="text-blocks bg-white">
          <h1>${this.story.text4.title}</h1>
          ${this.story.text4.paragraphs.map(t=>V`<p>${t}</p>`)}
      ...
      ${this.story.text5?V`
        <section class="text-image-pairing bg-tan">
          <div class="text-blocks">
            ...
            ${this.story.text5.paragraphs.map(t=>V`<p>${t}</p>`)}
          </div>
