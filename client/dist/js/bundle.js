    ...
    <section>
      ...
      <main>
        ${this.moments.map(t=>V`
          <div id="${t.entrypoint.shortName}" class="${t.entrypoint.shortName}">
            <div class="card">
              <div class="feature-img ${t.entrypoint.shortName}"
                style="background-image: url('/images/${t.headerImage}');"></div>
              <div class="content">
                <h4>${t.entrypoint.title}</h4>
                <em>
                  ${t.entrypoint.startDate}
                  <span ?hidden="${!t.entrypoint.endDate}">
                    - ${t.entrypoint.endDate}
                  </span>
                </em>
                <p>${t.entrypoint.text}</p>
              </div>
              <div class="footer">
                <button
                  name="${t.entrypoint.shortName}"
...
`}customElements.define("app-about",class extends ht{static get properties(){return{active:{type:Boolean}}}constructor(){super(),this.render=jt.bind(this),this.active=!0}});let Vt=i(26);class Bt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{active:{type:Boolean},moments:{type:Array}}}constructor(){super(),this.render=Rt.bind(this),this.active=!0,this.moments=[],this.loadMoments(),this._injectModel("AppStateModel")}loadMoments(){for(let t in Vt.moments)this.moments.push(Vt.moments[t])}_onReadStoryClick(t){this.AppStateModel.setLocation("/story/"+t)}_onExploreMapClick(t){this.AppStateModel.setLocation("/map/"+t)}}customElements.define("app-home",Bt);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
const Dt=(t,e)=>{const i=t.startNode.parentNode,n=void 0===e?t.endNode:e.startNode,o=i.insertBefore(v(),n);i.insertBefore(v(),n);const r=new P(t.options);return r.insertAfterNode(o),r},Zt=(t,e)=>(t.setValue(e),t.commit(),t),Ft=(t,e,i)=>{const n=t.startNode.parentNode,o=i?i.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&a(n,e.startNode,r,o)},Ut=t=>{l(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},qt=(t,e,i)=>{const n=new Map;for(let o=e;o<=i;o++)n.set(t[o],o);return n},$t=new WeakMap,Gt=new WeakMap,Wt=o((t,e,i)=>{let n;return void 0===i?i=e:void 0!==e&&(n=e),e=>{if(!(e instanceof P))throw new Error("repeat can only be used in text bindings");const o=$t.get(e)||[],r=Gt.get(e)||[],s=[],a=[],l=[];let h,c,d=0;for(const e of t)l[d]=n?n(e,d):d,a[d]=i(e,d),d++;let p=0,u=o.length-1,f=0,m=a.length-1;for(;p<=u&&f<=m;)if(null===o[p])p++;else if(null===o[u])u--;else if(r[p]===l[f])s[f]=Zt(o[p],a[f]),p++,f++;else if(r[u]===l[m])s[m]=Zt(o[u],a[m]),u--,m--;else if(r[p]===l[m])s[m]=Zt(o[p],a[m]),Ft(e,o[p],s[m+1]),p++,m--;else if(r[u]===l[f])s[f]=Zt(o[u],a[f]),Ft(e,o[u],o[p]),u--,f++;else if(void 0===h&&(h=qt(l,f,m),c=qt(r,p,u)),h.has(r[p]))if(h.has(r[u])){const t=c.get(l[f]),i=void 0!==t?o[t]:null;if(null===i){const t=Dt(e,o[p]);Zt(t,a[f]),s[f]=t}else s[f]=Zt(i,a[f]),Ft(e,i,o[p]),o[t]=null;f++}else Ut(o[u]),u--;else Ut(o[p]),p++;for(;f<=m;){const t=Dt(e,s[m+1]);Zt(t,a[f]),s[f++]=t}for(;p<=u;){const t=o[p++];null!==t&&Ut(t)}$t.set(e,s),Gt.set(e,l)}});function Jt(){return V`
  ...
  `}function Yt(){return V`
    ...
    <div id="container" class="container" role="main">      
      ...
      ${this.story.paragraph2?V`<section class="${this.story.paragraph2.image?"text-image-pairing bg-tan":"text-blocks bg-white"}">
          ${this.story.paragraph2.image?V`
      ...
      ${this.story.paragraph3?V`<section class="${this.story.paragraph3.image?"text-image-pairing bg-tan":"text-blocks bg-white"}">
          ${this.story.paragraph3.image?V`
      ...
      ${this.story.paragraph4?V`<section class="${this.story.paragraph4.image?"text-image-pairing bg-tan":"text-blocks bg-white"}">
          ${this.story.paragraph4.image?V`
      ...
      ${this.story.triptych["@id"]?V`
          <div class="triptych">
          ${Wt(this.story.triptych.image,t=>V`            
        ...
        `:V`
          <div class="triptych">
            ${this.story.triptych.image.map(t=>V`
              <div style="background-image: url('/images/${t.contentUrl}');">
                <span>
                  ${t.caption}
                </span>
              </div>
      ...
      ${this.story.paragraph5?V`<section class="${this.story.paragraph5.image?"text-image-pairing bg-tan":"text-blocks bg-white"}">                   
          <div class="text-blocks">
            <h1 ?hidden="${!this.story.paragraph5.headline}">${this.story.paragraph5.headline}</h1>
            <p>${this.story.paragraph5.text}</p>
          </div>
          ${this.story.paragraph5.image?V`
      ...
      <footer>
        ...
        ${this.story.sources?V`
          <div class="bottom-content">
            <h6>Sources</h6>
            <ol>          
            ${this.story.sources.map(t=>V`
              <li>
                <em>
                  ${t.text}
...
`}customElements.define("app-story-float-btn",class extends ht{static get properties(){return{active:{type:Boolean}}}constructor(){super(),this.render=Jt.bind(this),this.active=!0}});let Kt=i(26);class Xt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{active:{type:Boolean},endpoint:{type:String},headerImgUrl:{type:String},moment:{type:String},story:{type:Object},title:{type:String},jsonData:{type:Object}}}constructor(){super(),this.render=Yt.bind(this),this.active=!0,this.endpoint=APP_CONFIG.endpoint,this.moment="",this.headerImgUrl="",this.story={},this.title="",this.jsonData=Kt,this._injectModel("AppStateModel","MomentModel")}_onMomentGraphUpdate(t){"loaded"===t.state&&this.renderStory(t.payload)}async firstUpdated(){window.IntersectionObserver||(console.log("Injecting IntersectionObserver polyfill"),await i.e(0).then(i.t.bind(null,81,7))),this._initIntersectionObserver()}_onAppStateUpdate(t){this.moment=t.moment,this.renderStory()}renderStory(t){if(t)return 0!==Object.keys(t.graph.story).length?(this.story=t.graph.story,this.title=t.graph.story.entrypoint.headline,this.headerImgUrl=this.endpoint+"/"+this.moment+"/"+t.graph.story.entrypoint.thumbnail.replace("z:",""),void console.log(this.story)):void(this.jsonData.moments[this.moment]&&(this.story=this.jsonData.moments[this.moment],this.title=this.story.entrypoint.headline,this.headerImgUrl="/images/"+this.story.entrypoint.thumbnail))}_initIntersectionObserver(){this.floatBtn=this.shadowRoot.getElementById("floatBtn"),this.footer=this.shadowRoot.querySelector("footer");new window.IntersectionObserver(t=>{t[0].isIntersecting?(this.floatBtn.style.visibility="hidden",this.floatBtn.style.opacity=0,this.floatBtn.style.transition="visibility 0s .5s, opacity .5s ease"):(this.floatBtn.style.visibility="visible",this.floatBtn.style.opacity=1)}).observe(this.footer)}_launchMap(){this.AppStateModel.setLocation("/map/"+this.moment)}}customElements.define("app-story",Xt);let Qt=i(26);class te extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{baseUrl:{type:String},subtitle:{type:String},jsonData:{type:Object}}}constructor(){super(),this.baseUrl=window.location.protocol+"//"+window.location.host,this.subtitle="",this.jsonData=Qt,this.render=kt.bind(this),this._injectModel("AppStateModel")}_onAppStateUpdate(t){if("home"===t.page||"about"===t.page)this.subtitle="California's Modern Wine Network";else for(let e in this.jsonData.moments)t.moment===e&&(this.subtitle=this.jsonData.moments[e].title)}_onAboutClick(){this.AppStateModel.setLocation("/about/")}}function ee(){return V`
  <style>
    :host {
      display: block;
      position: absolute;
