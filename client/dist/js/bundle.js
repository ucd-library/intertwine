    ...
    <div id="container" class="container" role="main">      
      ...
      ${this.story.imageleft?V`<section class="text-image-pairing">
        ${this.story.imageleft.thumbnail?V`<div class="image" style="background-image: url('${this.endpoint}/${this.moment}/${this.story.imageleft.thumbnail}');">
          ...
          </div>`:V`<div class="image" style="background-image: url('/images/${this.story.imageleft.src}');">
            <span>${this.story.imageleft.caption}</span>
          </div>`}            
          <div class="text-blocks">
      ...
      ${this.story.paragraph2?V`<section class="text-blocks">        
          <div class="text-blocks">
      ...
      ${this.story.paragraph3?V`<section class="text-blocks">    
          <div class="text-blocks">
      ...
      ${this.story.paragraph4?V`<section class="text-blocks">    
          <div class="text-blocks">
...
`}customElements.define("app-story-float-btn",class extends ht{static get properties(){return{active:{type:Boolean}}}constructor(){super(),this.render=Jt.bind(this),this.active=!0}});let Kt=i(26);class Xt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{active:{type:Boolean},endpoint:{type:String},headerImgUrl:{type:String},moment:{type:String},story:{type:Object},sources:{type:Array},title:{type:String},jsonData:{type:Object}}}constructor(){super(),this.render=Yt.bind(this),this.active=!0,this.endpoint=APP_CONFIG.endpoint,this.moment="",this.headerImgUrl="",this.story={},this.sources=[],this.title="",this.jsonData=Kt,this._injectModel("AppStateModel","MomentModel")}_onMomentGraphUpdate(t){"loaded"===t.state&&this.renderStory(t.payload)}async firstUpdated(){window.IntersectionObserver||(console.log("Injecting IntersectionObserver polyfill"),await i.e(0).then(i.t.bind(null,81,7))),this._initIntersectionObserver()}_onAppStateUpdate(t){this.moment=t.moment,this.renderStory()}renderStory(t){if(t)if(0===Object.keys(t.graph.story).length)this.jsonData.moments[this.moment]&&(this.story=this.jsonData.moments[this.moment],this.title=this.story.entrypoint.headline,this.headerImgUrl="/images/"+this.story.entrypoint.thumbnail,this.sources=this.story.sources);else{this.story=t.graph.story,this.title=t.graph.story.entrypoint.headline,this.headerImgUrl=this.endpoint+"/"+this.moment+"/"+t.graph.story.entrypoint.thumbnail.replace("z:","");for(let t in this.story.sources.publication){let e=this.story.sources.publication[t].split(/\[|\]/),i={text:e[0],link:e[1],href:e[2]?e[2].replace(/\(|\)/,""):""};this.sources.push(i)}}}_initIntersectionObserver(){this.floatBtn=this.shadowRoot.getElementById("floatBtn"),this.footer=this.shadowRoot.querySelector("footer");new window.IntersectionObserver(t=>{t[0].isIntersecting?(this.floatBtn.style.visibility="hidden",this.floatBtn.style.opacity=0,this.floatBtn.style.transition="visibility 0s .5s, opacity .5s ease"):(this.floatBtn.style.visibility="visible",this.floatBtn.style.opacity=1)}).observe(this.footer)}_launchMap(){this.AppStateModel.setLocation("/map/"+this.moment)}}customElements.define("app-story",Xt);let Qt=i(26);class te extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{baseUrl:{type:String},subtitle:{type:String},jsonData:{type:Object}}}constructor(){super(),this.baseUrl=window.location.protocol+"//"+window.location.host,this.subtitle="",this.jsonData=Qt,this.render=kt.bind(this),this._injectModel("AppStateModel")}_onAppStateUpdate(t){if("home"===t.page||"about"===t.page)this.subtitle="California's Modern Wine Network";else for(let e in this.jsonData.moments)t.moment===e&&(this.subtitle=this.jsonData.moments[e].title)}_onAboutClick(){this.AppStateModel.setLocation("/about/")}}function ee(){return V`
  <style>
    :host {
      display: block;
      position: absolute;
