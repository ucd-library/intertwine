...
const Dt=(t,e)=>{const i=t.startNode.parentNode,n=void 0===e?t.endNode:e.startNode,o=i.insertBefore(v(),n);i.insertBefore(v(),n);const r=new P(t.options);return r.insertAfterNode(o),r},Zt=(t,e)=>(t.setValue(e),t.commit(),t),Ft=(t,e,i)=>{const n=t.startNode.parentNode,o=i?i.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&a(n,e.startNode,r,o)},Ut=t=>{l(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},qt=(t,e,i)=>{const n=new Map;for(let o=e;o<=i;o++)n.set(t[o],o);return n},$t=new WeakMap,Gt=new WeakMap,Wt=o((t,e,i)=>{let n;return void 0===i?i=e:void 0!==e&&(n=e),e=>{if(!(e instanceof P))throw new Error("repeat can only be used in text bindings");const o=$t.get(e)||[],r=Gt.get(e)||[],s=[],a=[],l=[];let h,c,d=0;for(const e of t)l[d]=n?n(e,d):d,a[d]=i(e,d),d++;let p=0,u=o.length-1,f=0,m=a.length-1;for(;p<=u&&f<=m;)if(null===o[p])p++;else if(null===o[u])u--;else if(r[p]===l[f])s[f]=Zt(o[p],a[f]),p++,f++;else if(r[u]===l[m])s[m]=Zt(o[u],a[m]),u--,m--;else if(r[p]===l[m])s[m]=Zt(o[p],a[m]),Ft(e,o[p],s[m+1]),p++,m--;else if(r[u]===l[f])s[f]=Zt(o[u],a[f]),Ft(e,o[u],o[p]),u--,f++;else if(void 0===h&&(h=qt(l,f,m),c=qt(r,p,u)),h.has(r[p]))if(h.has(r[u])){const t=c.get(l[f]),i=void 0!==t?o[t]:null;if(null===i){const t=Dt(e,o[p]);Zt(t,a[f]),s[f]=t}else s[f]=Zt(i,a[f]),Ft(e,i,o[p]),o[t]=null;f++}else Ut(o[u]),u--;else Ut(o[p]),p++;for(;f<=m;){const t=Dt(e,s[m+1]);Zt(t,a[f]),s[f++]=t}for(;p<=u;){const t=o[p++];null!==t&&Ut(t)}$t.set(e,s),Gt.set(e,l)}});function Jt(){return V`
  ...
  `}function Yt(){return V`
    ...
    <div id="container" class="container" role="main">      
      ...
      ${this.story.imageleft?V`<section class="text-image-pairing">
        ${this.story.imageleft.thumbnail?V`<div class="image" style="background-image: url('${this.endpoint}/${this.moment}/${this.story.imageleft.thumbnail}');">
            <span>${this.story.imageleft.caption}</span>
          </div>`:V`<div class="image" style="background-image: url('${this.story.imageleft.src}');">
            <span>${this.story.imageleft.caption}</span>
          </div>`}            
          <div class="text-blocks">
      ...
      ${this.story.imageright?V`<section class="text-image-pairing">            
          <div class="text-blocks">
