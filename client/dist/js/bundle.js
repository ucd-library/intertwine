 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const A=new class{handleAttributeExpressions(t,e,i,n){const o=e[0];if("."===o){return new P(t,e.slice(1),i).parts}return"@"===o?[new E(t,e.slice(1),n.eventContext)]:"?"===o?[new M(t,e.slice(1),i)]:new C(t,e,i).parts}handleTextExpression(t){return new S(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
