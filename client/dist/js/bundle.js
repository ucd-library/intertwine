...
const Rt=(t,e)=>{const i=t.startNode.parentNode,n=void 0===e?t.endNode:e.startNode,o=i.insertBefore(v(),n);i.insertBefore(v(),n);const r=new P(t.options);return r.insertAfterNode(o),r},Vt=(t,e)=>(t.setValue(e),t.commit(),t),Bt=(t,e,i)=>{const n=t.startNode.parentNode,o=i?i.startNode:t.endNode,r=e.endNode.nextSibling;r!==o&&a(n,e.startNode,r,o)},Dt=t=>{l(t.startNode.parentNode,t.startNode,t.endNode.nextSibling)},Zt=(t,e,i)=>{const n=new Map;for(let o=e;o<=i;o++)n.set(t[o],o);return n},Ft=new WeakMap,Ut=new WeakMap,qt=o((t,e,i)=>{let n;return void 0===i?i=e:void 0!==e&&(n=e),e=>{if(!(e instanceof P))throw new Error("repeat can only be used in text bindings");const o=Ft.get(e)||[],r=Ut.get(e)||[],s=[],a=[],l=[];let h,c,d=0;for(const e of t)l[d]=n?n(e,d):d,a[d]=i(e,d),d++;let p=0,u=o.length-1,f=0,m=a.length-1;for(;p<=u&&f<=m;)if(null===o[p])p++;else if(null===o[u])u--;else if(r[p]===l[f])s[f]=Vt(o[p],a[f]),p++,f++;else if(r[u]===l[m])s[m]=Vt(o[u],a[m]),u--,m--;else if(r[p]===l[m])s[m]=Vt(o[p],a[m]),Bt(e,o[p],s[m+1]),p++,m--;else if(r[u]===l[f])s[f]=Vt(o[u],a[f]),Bt(e,o[u],o[p]),u--,f++;else if(void 0===h&&(h=Zt(l,f,m),c=Zt(r,p,u)),h.has(r[p]))if(h.has(r[u])){const t=c.get(l[f]),i=void 0!==t?o[t]:null;if(null===i){const t=Rt(e,o[p]);Vt(t,a[f]),s[f]=t}else s[f]=Vt(i,a[f]),Bt(e,i,o[p]),o[t]=null;f++}else Dt(o[u]),u--;else Dt(o[p]),p++;for(;f<=m;){const t=Rt(e,s[m+1]);Vt(t,a[f]),s[f++]=t}for(;p<=u;){const t=o[p++];null!==t&&Dt(t)}Ft.set(e,s),Ut.set(e,l)}});function $t(){return V`
  ...
  `}function Gt(){return V`
    ...
    <div id="container" class="container" role="main">
      ...
      ${this.orderedStory.map(t=>V`
        <section class="${t.label}">
          ${"text"===t.label?V`
            <div class="text-blocks">
              <h1 ?hidden="${!t.headline}">${t.headline}</h1>
              ${Array.isArray(t.text)?V`${t.text.map(t=>V`<p>${t}</p>`)}`:V`${t.text}`}
            </div>`:V``}

          ${"imagetext"===t.label?V`
            ${t.thumbnail?V`<div class="image" style="background-image: url('${this.endpoint}/${this.moment}/${t.thumbnail}');">
              <span>${t.caption}</span>
            </div>`:V`<div class="image" style="background-image: url('${t.src}');"><span>${t.caption}</span></div>`}
            <div class="text-blocks">
              <h1 ?hidden="${!t.headline}">${t.headline}</h1>
          ...
          ${"textimage"===t.label?V`
            ...
            <div class="image" style="background-image: url('${this.endpoint}/${this.moment}/${t.thumbnail}');">
              <span>${t.caption}</span>
            </div>`:V``}
          
          ${"triptych"===t.label&&t["@id"]?V`
            <div class="triptych">
              ${qt(t.image,e=>V`
                <div style="background-image: url('${this.endpoint}/${this.moment}/${t["@id"]}/${e.contentUrl}');">
                  <span>${e.caption}</span>
                </div>`)}
            </div>`:V``}
        </section>
...
`}customElements.define("app-story-float-btn",class extends ht{static get properties(){return{}}constructor(){super(),this.render=$t.bind(this)}});class Wt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{endpoint:{type:String},headerImgUrl:{type:String},moment:{type:String},paragraphs:{type:Array},orderedStory:{type:Array},story:{type:Object},sources:{type:Array},title:{type:String}}}constructor(){super(),this.render=Gt.bind(this),this.endpoint=APP_CONFIG.endpoint,this.moment="",this.headerImgUrl="",this.paragraphs=[],this.story={},this.sources=[],this.paragraphs=[],this.orderedStory=[],this.title="",this._injectModel("AppStateModel","MomentModel")}async firstUpdated(){this.container=this.shadowRoot.querySelector("#container"),window.IntersectionObserver||(console.log("Injecting IntersectionObserver polyfill"),await i.e(0).then(i.t.bind(null,81,7))),this._initIntersectionObserver()}async _onAppStateUpdate(t){this.container.scrollTo(0,0),this.moment=t.moment;let e=await this.MomentModel.get(this.moment);this.renderStory(e.payload)}renderStory(t){if(t&&0!==Object.keys(t.graph.story).length){this.story=t.graph.story,this.title=t.graph.story.entrypoint.name,this.orderedStory=[];for(let t in this.story)this.orderedStory.push(this.story[t]);this.orderedStory.sort((t,e)=>t["schema:position"]-e["schema:position"]);for(let t=0;t<this.orderedStory.length;t++)this.orderedStory[t].label=this.orderedStory[t].label.replace(/\s|\/|story:/gi,"").toLowerCase();if(t.graph.story.entrypoint.thumbnail?null===t.graph.story.entrypoint.thumbnail.match(/^https?:\/\//g)?this.headerImgUrl=this.endpoint+"/"+this.moment+"/"+t.graph.story.entrypoint.thumbnail:this.headerImgUrl=t.graph.story.entrypoint.thumbnail:this.headerImgUrl=this.endpoint+"/"+this.moment+"/thumbnail.jpg",this.story.sources){this.sources=[];for(let t in this.story.sources.publication){let e=this.story.sources.publication[t].split(/\[|\]/),i={text:e[0],link:e[1],href:e[2]?e[2].replace(/\(|\)/,""):""};this.sources.push(i)}}}}_initIntersectionObserver(){this.floatBtn=this.shadowRoot.getElementById("floatBtn"),this.footer=this.shadowRoot.querySelector("footer");new window.IntersectionObserver(t=>{t[0].isIntersecting?this.floatBtn.classList.add("hidden"):this.floatBtn.classList.remove("hidden")}).observe(this.footer)}_launchMap(){this.AppStateModel.setLocation("/map/"+this.moment)}}customElements.define("app-story",Wt);class Yt extends(Mixin(ht).with(LitCorkUtils)){static get properties(){return{baseUrl:{type:String},subtitle:{type:String},moments:{type:Array}}}constructor(){super(),this.baseUrl=window.location.protocol+"//"+window.location.host,this.subtitle="",this.moments=[],this.render=kt.bind(this),this._injectModel("AppStateModel","MomentModel")}async _onAppStateUpdate(t){if("home"===t.page||"about"===t.page)this.subtitle="California's Modern Wine Network";else{this.moment=t.moment;let e=await this.MomentModel.get(this.moment);this._setSubtitle(e.payload)}}_setSubtitle(t){0!==Object.keys(t.graph.story).length&&(this.subtitle=t.graph.story.entrypoint.name)}_onAboutClick(){this.AppStateModel.setLocation("/about/")}}function Jt(){return V`
  <style>
    :host {
      display: block;
      position: absolute;
